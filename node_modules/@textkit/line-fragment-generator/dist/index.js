  ...
  return function (_ref) {
    ...
    return function () {
      function LineFragmentGenerator() {
        (0, _classCallCheck3.default)(this, LineFragmentGenerator);
      }

      LineFragmentGenerator.prototype.generateFragments = function generateFragments(lineRect, container) {
        var rects = this.splitLineRect(lineRect, container.polygon, 'INTERIOR');
        var exclusion = container.exclusionPolygon;

        if (exclusion) {
          var res = [];
          for (var _iterator = rects, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : (0, _getIterator3.default)(_iterator);;) {
            var _ref2;
            ...
            res.push.apply(res, this.splitLineRect(rect, exclusion, 'EXTERIOR'));
          }
      ...
      LineFragmentGenerator.prototype.splitLineRect = function splitLineRect(lineRect, polygon, type) {
        var minY = lineRect.y;
        ...
        for (var _iterator2 = markers, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : (0, _getIterator3.default)(_iterator2);;) {
          var _ref3;
